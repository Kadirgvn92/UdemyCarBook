...
namespace UdemyCarBook.Persistance.Migrations
{
    ...
    [Migration("20240811210125_ReservationStatus")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UdemyCarBook.Domain.Entities.RentACarProcess", b =>
                {
                    ...
                    b.Property<string>("DropOfDescription")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("DropOfLocation")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UdemyCarBook.Domain.Entities.Car", b =>
                {
                    b.HasOne("UdemyCarBook.Domain.Entities.Brand", "Brands")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("UdemyCarBook.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.HasOne("UdemyCarBook.Domain.Entities.Location", "DropofLocation")
                        .WithMany("DropofReservation")
            ...
            modelBuilder.Entity("UdemyCarBook.Domain.Entities.Location", b =>
                {
                    b.Navigation("DropofReservation");
